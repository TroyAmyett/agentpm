...
export function VideoCard({
  ...
  return (
    <article className="radar-glass-card overflow-hidden group relative">
      {onDismiss && (
        <button
      ...
      >
        ...
        <div className="absolute inset-0 bg-black/40 opacity-0 group-hover:opacity-100 transition-opacity flex items-center justify-center">
          <div className="w-14 h-14 rounded-full bg-[#0ea5e9] flex items-center justify-center">
      ...
      <div className="p-4">
        ...
        <a
          ...
          target="_blank"
          rel="noopener noreferrer"
          className="block hover:text-[#0ea5e9] transition-colors"
        >

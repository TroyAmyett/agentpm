...
export interface Task extends BaseEntity {
  ...
  // Task type and auto-generation
  taskType?: 'development' | 'qa' | 'review' | 'documentation' | 'design' | 'other'
  autoGenerated?: boolean
  sourceTaskId?: string  // Task that triggered auto-generation (e.g., parent for QA task)
